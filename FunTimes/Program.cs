...
namespace FunTimes
{
    class Program
    {
        ...
        private static void GoEast_Run()
        {
        ...
        private static void GoEast_Attack()
        {
        ...
        private static void ForkRight_Talk()
        {
        ...
        private static void ForkRight_Run()
        {
            ...
            Console.WriteLine(
                "this road is one big loop idiot, what did you think would happen running away from a bandit like that");
        }

        private static void ForkRight_SneakAttack()
        {
        ...
        private static void ForkLeft()
        {
            Console.WriteLine(
                "you start walking down the left path and come to a small village. The place is busy considering how small it seems.");

            Console.WriteLine(
                "You stroll down road smiling and waving at any villager who glances your way. Travelers must be common around here.");
